...
#define TIMEOUT_CHECK_MOUSE_STATE							100 /* in millisecond */
#define TIMEOUT_FULLSCREAN_CHECK_MOUSE_STATE				100 /* in millisecond */
#define TIME_PRESSED_LEFT									5	/* in count */
...
#define OPOLYGLOT_CONFIG_BOOL_METHOT_CREATION_TEXT			wxS("MethodCreationTextNew") /* true - new , false - append */
#define OPOLYGLOT_CONFIG_BOOL_METHOT_CREATION_TEXT_DEFAULT  true
