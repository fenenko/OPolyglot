...
cmake  -DSSPLIT_USE_INTERNAL_PCRE2=ON -DCOMPILE_LIBRARY_ONLY=ON -DCMAKE_SYSTEM_PROCESSOR=x86_64 -DBUILD_ARCH=core2 -DUSE_THREAD=ON -DCMAKE_BUILD_TYPE=Release ../
